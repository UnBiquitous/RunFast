...
public class Car extends GameObject{
	...
	private int topCollision;
	private int leftCollision;
	private int bottomCollision;
	private int rightCollision;
	
	//Attributes
	private int speed, speedMax, acceleration;
	private boolean accelerating;
	private double rotation, rotateRate;
	private int rotateSense;
	private double sightRotation;
	private int sightRotateSense;
	private int fuel;
	private int laps;//LAPS???
	private boolean inLap;
	private boolean inLapCorrect;
	...
	private void initImages(CarTemplate carType) {
		...
		ImageIcon ii = new ImageIcon(getClass().getResource("../images/game/sight.png"));
	 ...
	 * @return newRotation
	 */
	private double rotate(double rotation, int rotateSense) {
		rotation %= 360;
		if(rotateSense!=ROTATE_NONE) {
			...
			if(((rotateSense&ROTATE_UP)!=0)&&(!turnedDown)) {
				canRotate = true;
			...
			if(((rotateSense&ROTATE_DOWN)!=0)&&(!turnedUp)) {
				canRotate = true;
			...
			if(((rotateSense&ROTATE_LEFT)!=0)&&(!turnedRight)) {
				canRotate = true;
				if(rotation>180)
					rotate = -rotateRate;
			...
			if(((rotateSense&ROTATE_RIGHT)!=0)&&(!turnedLeft)) {
				canRotate = true;
	 ...
	 * @param sense
	 */
	public void startRotation(int sense) {
		rotateSense |= sense;
	}
	 ...
	 * @param sense
	 */
	public void startSightRotation(int sense) {
